---
title: "Discrete Time Markov Model Analysis of Cognitive Decline"
...
abstract: |
  This analysis examines transitions between cognitive states (Normal Cognition, MCI, Dementia) using discrete-time Markov models, with particular focus on procrastination as a risk factor.
toc: true
toc-depth: 3
...
```{r data}
data <- readxl::read_xlsx(here::here("data/data.xlsx"))
```
...
```{r non-stationary-visualise}
#| code-fold: true
#| code-summary: "Check our my code"
#| fig-width: 12
#| fig-height: 10
#| label: fig-non-stationary
#| fig-cap: "Predicted transition probabilities from the non-stationary model."
#| 
expand.grid(
  Gender = factor(0),
  status_prev = levels(data_stack$status_prev),
